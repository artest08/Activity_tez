...
if __name__ == '__main__':
    ...
    parser.add_argument("--src_dir", type=str, default='/media/esat/8234cf14-fc0e-441d-b606-0b7906d5d9c9/DenseTrajectory/UCF101/UCF-101',
                        help='path to the video data')
    parser.add_argument("--out_dir", type=str, default='/media/esat/8234cf14-fc0e-441d-b606-0b7906d5d9c9/tsnCoffe/two-stream-pytorch/datasets/ucf101_frames',
