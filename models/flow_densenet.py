...
__all__ = ['DenseNet', 'flow_densenet121', 'flow_densenet169', 'flow_densenet201', 'flow_densenet161']
...
class DenseNet(nn.Module):
    ...
    def __init__(self, growth_rate=32, block_config=(6, 12, 24, 16),
        ...
        self.features = nn.Sequential(OrderedDict([
            ('conv0', nn.Conv2d(20, num_init_features, kernel_size=7, stride=2, padding=3, bias=False)),
        ...
        # Linear layer
        self.classifierModified = nn.Linear(num_features, num_classes)
    ...
    def forward(self, x):
        ...
        out = self.classifierModified(out)
        return out
...
def _load_state_dict(model, model_url):
    ...
    new_pretrained_dict = change_key_names(pretrained_dict, 20)
...
def flow_densenet121(pretrained=False, **kwargs):
...
def flow_densenet169(pretrained=False, **kwargs):
...
def flow_densenet201(pretrained=False, **kwargs):
...
def flow_densenet161(pretrained=False, **kwargs):
