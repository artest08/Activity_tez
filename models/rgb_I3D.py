...
from .non_local.models.resnet import I3Res50, I3Res50_8x8
...
class rgb_resnet50I3D64f_stride2(nn.Module):
    def __init__(self, num_classes , length, modelPath=''):
        super(rgb_resnet50I3D64f_stride2, self).__init__()
        self.num_classes=num_classes
        self.dp = nn.Dropout(p=0.8)
        #self.avgpool = nn.AvgPool3d((8, 7, 7), stride=1)
        self.avgpool = nn.AdaptiveAvgPool3d(output_size=(1, 1, 1))
...
class rgb_resnet50I3D64f_8x8(nn.Module):
    def __init__(self, num_classes , length, modelPath=''):
        super(rgb_resnet50I3D64f_8x8, self).__init__()
        self.num_classes=num_classes
        self.dp = nn.Dropout(p=0.8)
        #self.avgpool = nn.AvgPool3d((8, 7, 7), stride=1)
        self.avgpool = nn.AdaptiveAvgPool3d(output_size=(1, 1, 1))

        self.features=nn.Sequential(*list(_resnet50_8x8(model_path=modelPath).children())[:-3])
...
class rgb_resnet50I3D32f_112(nn.Module):
    def __init__(self, num_classes , length, modelPath=''):
        super(rgb_resnet50I3D32f_112, self).__init__()
        self.num_classes=num_classes
        self.dp = nn.Dropout(p=0.8)
        #self.avgpool = nn.AvgPool3d((8, 7, 7), stride=1)
        self.avgpool = nn.AdaptiveAvgPool3d(output_size=(1, 1, 1))
...
class rgb_resnet50I3D64fNL(nn.Module):
    def __init__(self, num_classes , length, modelPath=''):
        super(rgb_resnet50I3D64fNL, self).__init__()
        self.num_classes=num_classes
        self.dp = nn.Dropout(p=0.8)
        #self.avgpool = nn.AvgPool3d((8, 7, 7), stride=1)
        self.avgpool = nn.AdaptiveAvgPool3d(output_size=(1, 1, 1))
...
class rgb_resnet50I3D64fNL_stride2(nn.Module):
    def __init__(self, num_classes , length, modelPath=''):
        super(rgb_resnet50I3D64fNL_stride2, self).__init__()
        self.num_classes=num_classes
        self.dp = nn.Dropout(p=0.8)
        #self.avgpool = nn.AvgPool3d((8, 7, 7), stride=1)
        self.avgpool = nn.AdaptiveAvgPool3d(output_size=(1, 1, 1))
...
class rgb_resnet50I3D64fNL_32fweight(nn.Module):
    def __init__(self, num_classes , length, modelPath=''):
        super(rgb_resnet50I3D64fNL_32fweight, self).__init__()
        self.num_classes=num_classes
        self.dp = nn.Dropout(p=0.8)
        #self.avgpool = nn.AvgPool3d((8, 7, 7), stride=1)
        self.avgpool = nn.AdaptiveAvgPool3d(output_size=(1, 1, 1))
...
class rgb_resnet50I3D32fNL_bert10(nn.Module):
    def __init__(self, num_classes , length, modelPath=''):
        ...
        self.features1=nn.Sequential(*list(_resnet50NL(model_path=modelPath).children())[:-5])
        self.features2=nn.Sequential(*list(_resnet50NL(model_path=modelPath).children())[-5:-3])
...
class rgb_resnet50I3D32f_bert10(nn.Module):
    def __init__(self, num_classes , length, modelPath=''):
        super(rgb_resnet50I3D32f_bert10, self).__init__()
        self.hidden_size=2048
        self.n_layers=1
        self.attn_heads=8
        self.num_classes=num_classes
...
class rgb_resnet50I3D128f_bert10(nn.Module):
    def __init__(self, num_classes , length, modelPath=''):
        super(rgb_resnet50I3D128f_bert10, self).__init__()
        self.hidden_size=2048
        self.n_layers=1
        self.attn_heads=8
        self.num_classes=num_classes
...
class rgb_I3D64f_bert10(nn.Module):
    def __init__(self, num_classes , length, modelPath=''):
        super(rgb_I3D64f_bert10, self).__init__()
...
class rgb_I3D64f_bert2B(nn.Module):
    def __init__(self, num_classes , length, modelPath=''):
        super(rgb_I3D64f_bert2B, self).__init__()
        self.hidden_size=512
        self.n_layers=1
        self.attn_heads=8
        self.num_classes=num_classes
...
class flow_I3D64f_bert2B(nn.Module):
    def __init__(self, num_classes , length, modelPath=''):
        super(flow_I3D64f_bert2B, self).__init__()
        self.hidden_size=512
        self.n_layers=1
        self.attn_heads=8
        self.num_classes=num_classes
...
class flow_I3D64f_bert10(nn.Module):
    def __init__(self, num_classes , length, modelPath=''):
        super(flow_I3D64f_bert10, self).__init__()
        self.hidden_size=1024
        self.n_layers=1
        self.attn_heads=8
        self.num_classes=num_classes
        ...
        self.features1=nn.Sequential(*list(_inception_flow(model_path=modelPath).children())[3:-11])
        
        for param in self.features1.parameters():
            param.requires_grad = True
            
        self.features2=nn.Sequential(*list(_inception_flow(model_path=modelPath).children())[-11:])
...
class pose_I3D64f_bert10(nn.Module):
    def __init__(self, num_classes , length, modelPath=''):
        super(pose_I3D64f_bert10, self).__init__()
        self.hidden_size=1024
        self.n_layers=1
        self.attn_heads=8
        self.num_classes=num_classes
...
def _resnet50_8x8(model_path, **kwargs):
    model = I3Res50_8x8(num_classes=400, use_nl=False)
    if model_path=='':
        return model
    params = torch.load(model_path)
    model.load_state_dict(params)
