...
sys.path.insert(0, "../../")
import models
from VideoSpatialPrediction_lstm2 import VideoSpatialPrediction_lstm2
...
parser.add_argument('--arch', '-a', metavar='ARCH', default='rgb_resnet18_lstmType7',
                    choices=model_names)
...
def main():
    ...
    for line in val_list:
        ...
        start = time.time()
        spatial_prediction = VideoSpatialPrediction_lstm2(
                clip_path,
                spatial_net,
                num_categories,
                start_frame,
