...
# -*- coding: utf-8 -*-
"""
Created on Thu Aug  8 19:13:49 2019
...
parser.add_argument('--lr_steps', default=[60], type=float, nargs="+",
...
#                                weight_decay=args.weight_decay)
    ...
    if modality == "rgb":
        ...
        clip_mean = [0.5, 0.5] * args.num_seg
        clip_std = [0.226, 0.226] * args.num_seg
    else:
...
def train(train_loader, model, criterion, optimizer, epoch):
    ...
    for i, (inputs, targets) in enumerate(train_loader):
        ...
        output, difference = model(inputs)
        ...
        #loss = criterion(output, targets) + 10*torch.mean(difference)
