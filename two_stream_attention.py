...
# -*- coding: utf-8 -*-
"""
Created on Thu Jul 11 19:06:46 2019
...
parser = argparse.ArgumentParser(description='PyTorch Two-Stream Attention Action Recognition')
...
parser.add_argument('--arch', '-a', metavar='ARCH', default='rgb_openpose_resnet101_type5',
                    choices=model_names,
...
parser.add_argument('--new_width', default=640, type=int,
                    metavar='N', help='resize width (default: 340)')
parser.add_argument('--new_height', default=512, type=int,
...
def main():
    ...
    train_transform = video_transforms.Compose([
            ...
            video_transforms.MultiScaleCrop((448, 448), scale_ratios),
    ...
    val_transform = video_transforms.Compose([
            # video_transforms.Scale((256)),
            video_transforms.CenterCrop((448)),
            video_transforms.ToTensor(),
            normalize,
        ])
...
def train(train_loader, model, criterion, optimizer, epoch):
    ...
    for i, (inputs, targets) in enumerate(train_loader):
        ...
        if (i+1) % args.iter_size == 0:
            ...
            losses.update(loss_mini_batch, output.size(0))
            top1.update(acc_mini_batch/args.iter_size, output.size(0))
            top3.update(acc_mini_batch_top3/args.iter_size, output.size(0))
